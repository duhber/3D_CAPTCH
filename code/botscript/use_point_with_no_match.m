...
%                 frames
            ...
            goodPointIndex=findGoodPoints(goodKeyPoints1,goodKeyPoints2,des1,locs1,des2,locs2);
            
            count=count+numel(goodPointIndex);
            
            for i=1:numel(goodPointIndex);
            x1=goodKeyPoints1(goodPointIndex(i),1);
            y1=goodKeyPoints1(goodPointIndex(i),2);
            
            x2=goodKeyPoints2(goodPointIndex(i),1);
            y2=goodKeyPoints2(goodPointIndex(i),2);
